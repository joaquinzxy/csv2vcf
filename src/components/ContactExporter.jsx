...
export function ContactExporter({ contacts = [] }) {
    const createVcfData = () => {
        let vcfData = '';
    ...
    return (
        <Container sx={{textAlign: 'center', mb: '3rem'}}>
          <Button variant="contained" color="info" onClick={handleExport} style={{marginTop: '2rem'}} disabled={contacts.length === 0}>
